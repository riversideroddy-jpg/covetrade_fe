    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full sm:max-w-[360px] max-h-[85vh] overflow-y-auto rounded-2xl bg-white dark:bg-[#0f1a2e] border border-gray-200 dark:border-white/10 shadow-2xl"
        >
          <div className="p-6">
            ...
            {loading ? (
              ...
              <div className="space-y-2.5">
                {transactions.map((tx) => (
                  <div
                    key={tx.id}
                    className="bg-gray-50 dark:bg-white/[0.04] border border-gray-200 dark:border-white/5 rounded-xl p-3"
                  >
                    <div className="flex items-start justify-between gap-2 mb-2">
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-gray-500 font-mono truncate">{tx.reference}</p>
                        </div>
                      </div>
                      <span className={`shrink-0 px-2 py-0.5 rounded text-[10px] font-medium ${getStatusColor(tx.status)}`}>
                        {tx.status_display}
                      </span>
                    </div>
